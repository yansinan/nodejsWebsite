...
let ArtistController = {
    ...
    async create(ctx, app) {
        ...
        try {
            ...
            let formObj=Object.assign({},await funGetData(fields),formObjCheck);
    ...
    async redictToUsers(ctx, app) {
        ...
        try {
            ...
            await ctx.service.artist.updateMany(ctx, targetIds, {
                uAuthor: targetUser
            })

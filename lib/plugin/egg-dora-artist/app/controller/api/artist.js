    ...
    async getOne(ctx, app) {
        ...
        try {
            ...
            let targetContent = await ctx.service.artist.item(ctx, {
                query: queryObj,
                files: '_id name alias sImg from listMembers discription clickNum roofPlacement type appShowType imageArr videoArr duration simpleComments comments videoImg state dismissReason isTop',//getContentListFields()
            });

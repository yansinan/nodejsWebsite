...
let ControllerPlugin = {
    ...
    getListFields (type = '') {
        ...
        if (type == 'normal') {
            ...
            files = '_id url name alias sImg date discription clickNum roofPlacement type appShowType imageArr videoArr duration simpleComments comments videoImg state dismissReason categories isTop from listHotMusics listLinks listMembers listDateDur dateStart dateEnd'
        }
    ...
    async getOne(ctx, app) {
        ...
        try {
            ...
            renderContent[0].objDocsRecords=await ctx.service.record.find(ctx.query, {
                ...
                query: {state: '2',listArtists:targetId},
                searchKeys: ['sImg', 'name', 'dateRelease', 'listFormatTags'],
                files: "sImg name dateRelease listFormatTags"
            });

...
let ControllerPlugin = {
    ...
    getListFields (type = '') {
        ...
        if (type == 'normal') {
            ...
            files = '_id url name alias sImg date discription clickNum roofPlacement type appShowType imageArr videoArr duration simpleComments comments videoImg state dismissReason categories isTop from'
        }

module.exports = app => {
  ...
  UserSchema.path('dateIn').get(function (v) {
    return !_.isEmpty(v) ? this.date : v;
  })
  ...
  UserSchema.virtual('avatarName').get(function () {
    return (this.name || this.userName).substring(0,1);
  });
